...
export default function ForgotPasswordPage() {
  ...
  if (isSent) {
    return (
      <div className="mx-auto flex w-full max-w-sm flex-col gap-4 rounded-2xl border border-line bg-surface p-8 text-center shadow-sm">
  ...
  return (
    <div className="mx-auto flex w-full max-w-sm flex-col gap-6 rounded-2xl border border-line bg-surface p-8 shadow-sm">
      <h1 className="text-2xl font-semibold tracking-tight">Відновлення паролю</h1>
